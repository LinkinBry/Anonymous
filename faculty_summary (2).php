...
if ($res && mysqli_num_rows($res) > 0) {
    ...
    $faculty_name = ($fres && mysqli_num_rows($fres) > 0) ? mysqli_fetch_assoc($fres)['name'] : 'Unknown Faculty';
    ...
    sendBrevoEmail(
        ...
        'Your review has been approved — OlshcoReview',
        approvedEmailHtml($row['username'], $faculty_name)
    );
}
