...
$_SESSION['session_expires'] = time() + _FS_TIMEOUT;
...
if (!$res || mysqli_num_rows($res) === 0) {
    echo json_encode(['summary' => "No approved reviews found for $month_str $year."]); exit();
}
...
if (!$summary) { echo json_encode(['error' => 'AI did not return a response.']); exit(); }
